...
//    av_dict_set(&options, "video_size", SCREEN_RES, 0);
//
...
//
//        window = SDL_CreateWindow("OpenPlaya", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_MAXIMIZED);
//        if (window == NULL)
//        {
...
//                                               codecContext->pix_fmt, 1920, 1080,
